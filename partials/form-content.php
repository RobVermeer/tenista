<div class="row">
	<div class="col-sm-3 col-sm-push-9">
		Het lidmaatschap duurt van september tot september en de contributie bedraagt:
		<table class="table">
			<thead>
				<tr>
		...
		De contributie maak je over naar:
		<strong>NL80 INGB 0005 4483 31 t.a.v. SVU Tenista
		O.v.v. naam en contributie</strong>
	...
	<div class="col-sm-9 col-sm-pull-3">
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select id="commissie" class="form-control" name="commissie">
						...
						<option>Weekendjeweg commissie</option>
						<option>Amsterdams Studenten TennisToernooi commissie</option>
						<option>Media commissie</option>
						<option>Nee bedankt, geen interesse</option>
					</select>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-sm-9">
					<button class="btn btn-default" style="background:#00008c;color:white;border:none;padding:9px 16px;float:left;" type="submit">Verzenden</button>
					<button class="btn btn-default" style="background:#ddd;color:black;border:none;padding:9px 16px;margin-left:10px;" type="reset">Reset</button>
				</div>
			</div>
		</form>
	</div>
